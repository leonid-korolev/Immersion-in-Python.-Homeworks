...
def jsn_writer(in_dct: dict, path: str, file_name: str) -> None:
    ...
    with open(file_path, 'w', encoding='utf-8') as f_out:
        json.dump(in_dct, f_out, indent=2)
...
def main():
    tst_path = 'homeworks/homework_7'
    result = dir_walker(tst_path)
    new_path = 'homeworks/homework_8/result_of_the_program'
 

    jsn_writer(result, new_path, 'result')
    pcl_writer(result, new_path, 'result')
    csv_writer(result, new_path, 'result')
